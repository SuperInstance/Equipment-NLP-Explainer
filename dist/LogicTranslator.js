...
exports.LogicTranslator = void 0;
/**
...
class LogicTranslator {
    ...
    translations;
    customTerminology;
    constructor(language = 'en', customTerminology = {}) {
     ...
     */
    describeTransformations(transformations) {
        const phrases = this.translations.phrases;
     ...
     */
    buildExplanation(pattern, _detailLevel = 'normal') {
     ...
     */
    buildConfidenceExplanation(confidence, conditions) {
        return {
            rawScore: confidence,
            ...
            factors: conditions.map(c => ({
                ...
                impact: c.result ? 'positive' : 'negative',
...
exports.LogicTranslator = LogicTranslator;
exports.default = LogicTranslator;
//# sourceMappingURL=LogicTranslator.js.map