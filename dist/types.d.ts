 ...
 */
export type EquipmentSlot = 'DISTILLATION' | 'EXPLANATION' | 'MONITORING' | 'SCALING' | 'TEACHING' | 'ORCHESTRATION';
/**
 ...
 */
export type LogicPatternType = 'decision' | 'transformation' | 'validation' | 'aggregation' | 'branching' | 'iteration' | 'composition' | 'fallback';
/**
