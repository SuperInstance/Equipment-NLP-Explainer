...
exports.ConfidenceExplainer = void 0;
/**
...
class ConfidenceExplainer {
     ...
     */
    generateBreakdown(score, componentScores) {
        const lines = [];
        const threshold = this.findThreshold(score);
        const percentage = Math.round(score * 100);
        lines.push(this.language === 'zh'
     ...
     */
    buildDescription(score, threshold) {
        const percentage = Math.round(score * 100);
        return this.language === 'zh'
     ...
     */
    buildInterpretation(score, threshold, _percentage) {
        const lines = [];
        lines.push(threshold.interpretation);
        lines.push('');
        lines.push(threshold.recommendation);
     ...
     */
    createFactor(factorType, impact, magnitude, customDescription) {
     ...
     */
    aggregateScores(scores, method = 'average') {
        if (scores.length === 0)
            return 0;
        switch (method) {
            case 'average':
     ...
     */
    explainScoreChange(oldScore, newScore, reason) {
...
exports.ConfidenceExplainer = ConfidenceExplainer;
exports.default = ConfidenceExplainer;
//# sourceMappingURL=ConfidenceExplainer.js.map